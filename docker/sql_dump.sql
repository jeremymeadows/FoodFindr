...
('5hfjf', 'Texas Road House on the Road', 'Texas Roadhouse is a legendary steak restaurant serving American cuisine from the best steaks and ribs to made-from-scratch sides & fresh-baked rolls.', 0, 0, 'American', 2, 'https://www.texasroadhouse.com/texas-roadhouse-master-menu.pdf', NULL, '31,-97'),
('8fjelsj', 'Mod Pizza GO', 'MOD Pizza is a business, but our real purpose is creating positive social impact in the lives of our employees and their communities. Yes, we make pizza, but our pizza makes people. Our measure for success isn\'t the number of MOD locations - it\'s the number of people employed and their well being.', 0, 0, 'Pizza', 1, 'https://modpizza.com/menu/', NULL, NULL),
('cjeks', 'Jimmy John\'s (Freakier and Faster)', 'Enjoy all Jimmy John\'s® has to offer when you order online for delivery or catering or stop by a location near you. Jimmy John\'s® is the ultimate local Sandwich shop with gourmet Sandwiches made from ingredients that are always freaky fresh.', 0, 0, 'Sandwiches', 1, 'https://www.jimmyjohns.com/menu/', NULL, '31.5365676,-97.127043'),
('kjh89', 'Dutch Bros Coffee Shack', 'Dutch Bros Coffee is a privately held drive-through coffee chain headquartered in Grants Pass, Oregon, United States, with company-owned and franchise locations throughout the western United States.', 1, 5, 'Coffee', 1, 'https://dutchbros.com/menu/', NULL, NULL);
